...
#let brand(meta) = {
  ...
  let font_body = font-stack(meta.at("font_body", default: none), "Libertinus Serif", "New Computer Modern")
  let font_title = font-stack(meta.at("font_title", default: none), "Libertinus Sans", "DejaVu Sans")
  let font_heading = font-stack(
    meta.at("font_heading", default: meta.at("font_title", default: none)),
    "Libertinus Sans",
    "DejaVu Sans",
  )
  let font_mono = font-stack(meta.at("font_mono", default: none), "DejaVu Sans Mono", "Libertinus Mono")
