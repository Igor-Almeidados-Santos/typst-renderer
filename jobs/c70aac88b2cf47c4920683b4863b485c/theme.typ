...
#let brand(meta) = {
  ...
  let code-bg = color-from(meta.at("color_code_bg", default: none), rgb(0x0D, 0x11, 0x17))
  let code-text = color-from(meta.at("color_code_text", default: none), rgb(0xE6, 0xED, 0xF6))
  ...
  #for block in blocks {
    ...
    if t == "heading" {
      ...
      if toc {
        ...
        let block-theme = if block.at("theme", default: none) != none {
