...
#let brand(meta) = {
  ...
  let font_title = font-stack(meta.at("font_title", default: none), "New Computer Modern Sans", "New Computer Modern")
  let font_heading = font-stack(
    meta.at("font_heading", default: meta.at("font_title", default: none)),
    "New Computer Modern Sans",
    "New Computer Modern",
  )
  let font_mono = font-stack(meta.at("font_mono", default: none), "New Computer Modern Mono", "Libertinus Mono")
