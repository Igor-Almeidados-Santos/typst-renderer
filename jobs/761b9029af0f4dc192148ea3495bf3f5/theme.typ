...
#let brand(meta) = {
  ...
  let code-border = color-from(
    meta.at("color_code_border", default: meta.at("brand_line", default: none)),
    line,
  )
  let code-header-bg = color-from(
    meta.at("color_code_header_bg", default: meta.at("brand_ink", default: none)),
    ink,
  )
  let code-header-text = color-from(
    meta.at("color_code_header_text", default: meta.at("brand_tint", default: none)),
    tint,
  )
...
#let code-block(b, lang, content) = [
  let code-surface = rgb("#0D1117")
  let code-border = rgb("#1F2937")
  let code-header = rgb("#111827")
  let code-header-text = rgb("#93C5FD")
  let code-ink = rgb("#E6EDF6")
  ...
  #block(
    ...
    #block(
      ...
      #set text(font: b.font_mono, size: 9pt, fill: code-ink)
