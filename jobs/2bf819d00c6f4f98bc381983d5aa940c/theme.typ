...
#let apply-page-style(b, book-title, chapter-label) = {
  ...
  #set heading(numbering: "1.", font: b.font_heading, fill: b.heading)
  #show heading.where(level: 1): set text(font: b.font_heading, size: 18pt, fill: b.heading)
  #show heading.where(level: 2): set text(font: b.font_heading, size: 14pt, fill: b.heading)
  #show heading.where(level: 3): set text(font: b.font_heading, size: 12pt, fill: b.heading-muted)
}
